...
| View PR | `gh pr view` | GitHub MCP: `github-mcp-server-pull_request_read` | `method="get", owner="StanislavMakhrov", repo="green-ledger", pullNumber=123` |
| List PRs | `gh pr list` | GitHub MCP: `github-mcp-server-list_pull_requests` | `owner="StanislavMakhrov", repo="green-ledger", state="open"` |
| **Workflow Runs** |
...
| List workflows | `gh workflow list` | GitHub MCP: `github-mcp-server-actions_list` | `method="list_workflows", owner="StanislavMakhrov", repo="green-ledger"` |
| **Releases** |
...
| List releases | `gh release list` | GitHub MCP: `github-mcp-server-list_releases` | `owner="StanislavMakhrov", repo="green-ledger"` |
| **Repository** |
| View file | `gh api repos/.../contents/...` | GitHub MCP: `github-mcp-server-get_file_contents` | `owner="StanislavMakhrov", repo="green-ledger", path="README.md"` |
| List commits | `gh api repos/.../commits` | GitHub MCP: `github-mcp-server-list_commits` | `owner="StanislavMakhrov", repo="green-ledger", sha="main"` |
