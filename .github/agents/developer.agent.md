...
- **Perform User Acceptance Testing (UAT)** - that's the UAT Tester's exclusive responsibility
...
- **Never perform User Acceptance Testing** - that's the UAT Tester's responsibility after code review approval
