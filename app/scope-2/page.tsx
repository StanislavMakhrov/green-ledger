/**
 * Scope 2 page — add and list indirect energy emission records.
 *
...
export default function Scope2Page() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-900 mb-2">Scope 2 — Purchased Energy</h1>
      <p className="text-gray-500 mb-6 text-sm">Indirect emissions from purchased electricity, heat, or cooling (location-based method).</p>
        ...
        <form onSubmit={handleAdd} className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Location-based (grid average)"
            />
          </div>
          <div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="Full-year consumption from utility bills..."
            />
          </div>
            ...
            {loading ? (
              ...
              records.map((r) => (
                <tr key={r.id} className="border-b border-gray-100">
                  ...
                  <td className="px-4 py-3 text-right font-mono font-semibold text-blue-700">{fmt(r.valueTco2e)}</td>
