...
export default function Scope1Client({
  ...
  const load = useCallback(async () => {
    ...
    const json = (await res.json()) as { data: Scope1Record[] };
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Scope 1 Emissions</h1>
          <p className="text-gray-500 mt-1">Direct emissions from owned or controlled sources</p>
        </div>
        <button
      ...
      {showForm && (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
          <h2 className="text-lg font-semibold text-gray-800 mb-4">New Scope 1 Record</h2>
