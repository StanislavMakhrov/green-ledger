...
export default function Scope1Page() {
  ...
  const handleDelete = async (id: string) => {
    ...
    await fetch(`/api/scope-1/${id}`, { method: "DELETE" });
    await load();
  };
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Scope 1 — Direct Emissions</h1>
        <button
      ...
      {showForm && (
        ...
        >
          <h2 className="font-semibold text-gray-700">New Scope 1 Record</h2>
