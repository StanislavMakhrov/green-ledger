...
import Scope2RecordForm from "./Scope2RecordForm";
...
interface Scope2RecordTableProps {
  initialRecords: Scope2Record[];
}

export default function Scope2RecordTable({
  initialRecords,
}: Scope2RecordTableProps) {
      ...
      {records.length === 0 ? (
        <div className="text-center py-12 text-gray-500">
          ...
          <p className="text-sm mt-1">
            Add indirect emission records from purchased electricity and heat.
          </p>
        </div>
      ) : (
        <Table>
